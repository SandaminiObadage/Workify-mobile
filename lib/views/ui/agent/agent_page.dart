...
import 'package:jobhubv2_0/views/ui/agent/widgets/uploaded_jobs.dart';
                                    ...
                                    FutureBuilder<GetAgent>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return Column(
                                            ...
                                            children: [
                                              ReusableText(
                                                text: agent!.company ?? 'Clutch Sports',
                                                style: appStyle(
                                                    10,
                                                    Colors.white,
                                                    FontWeight.w600),
                                              ...
                                              ReusableText(
                                                text:
                                                    agent.hqAddress ?? '822 N Laurel Ave, Los Angeles',
                                                style: appStyle(
                                                    10,
                                                    Colors.white,
                                                    FontWeight.normal),
                                              ...
                                              ReusableText(
                                                text: agent.workingHrs ?? "Mon - Fri 9:00 - 17:00",
                                                style: appStyle(
                                                    10,
                                                    Colors.white,
                                                    FontWeight.normal),
